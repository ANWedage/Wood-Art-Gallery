...
export default function Suppliers({
  ...
  return (
    <div className="raw-suppliers">
      <h1 className="inventory-dashboard-title">Suppliers</h1>
      <p className="section-description">Manage supplier contacts and procurement details.</p>
          ...
          <div className="modal" onMouseDown={e=>e.stopPropagation()}>
            ...
            <form onSubmit={submitSupplier} className="supplier-form">
              <div className="form-row">
                <label>Name</label>
                <input name="name" value={supplierForm.name} onChange={onSupplierChange} required />
              </div>
              <div className="form-row">
                <label>Email</label>
                <input type="email" name="email" value={supplierForm.email} onChange={onSupplierChange} required />
              </div>
              <div className="form-row">
                <label>Phone</label>
                <input name="phone" value={supplierForm.phone} onChange={onSupplierChange} required />
              </div>
              <div className="form-row">
                <label>Address</label>
              ...
              <div className="modal-actions">
                ...
                <button type="submit" className="primary-btn" disabled={savingSupplier}>{savingSupplier? 'Saving...' : editingSupplier ? 'Update Supplier' : 'Create Supplier'}</button>
              </div>
            </form>
          </div>
        </div>
            ...
            <form className="po-form" onSubmit={submitPO}>
              <div className="po-grid">
                ...
                <div className="form-row">
                  ...
                  <input type="number" name="quantity" min="1" value={poForm.quantity} onChange={onPOChange} required />
                </div>
                <div className="form-row">
              ...
              <div className="modal-actions">
                ...
                <button type="submit" className="primary-btn" disabled={submittingPO}>{submittingPO? 'Submitting...' : 'Submit'}</button>
              </div>
            </form>
          </div>
        </div>
