...
export default function StaffDesignerDashboard() {
  ...
  const renderContent = () => {
    switch(activePage) {
      case 'menu':
        return <StaffMenu setActivePage={setActivePage} />;
      case 'pending-orders':
        return (
          <PendingOrders 
      ...
      <div className="staffdesigner-dashboard-root">
        <aside className="staffdesigner-sidebar">
          ...
          <ul>
            ...
            <li className={activePage === 'request-material' ? 'active' : ''} onClick={() => setActivePage('request-material')}>
              <div className="menu-icon">📦</div>
              <span>Request Material</span>
            </li>
            <li className={activePage === 'received-materials' ? 'active' : ''} onClick={() => setActivePage('received-materials')}>
              <div className="menu-icon">📥</div>
